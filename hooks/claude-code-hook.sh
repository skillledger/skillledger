#!/usr/bin/env bash
# Pre-install verification hook for Claude Code skills
# Install: Add to .claude/hooks/pre-install or configure in claude settings
#
...
ARTIFACT="${1:?Usage: claude-code-hook.sh <artifact-path>}"
