...
name: design
description: >
  Elite UX/UI & Advanced GSAP Motion Engineer. Enforces Python-driven true randomization
  for layout variance, strict AIDA page structure, wide editorial typography (bans 6-line wraps),
  gapless bento grids, strict GSAP ScrollTriggers (pinning, stacking, scrubbing), inline
  micro-images, and massive section spacing.

  TRIGGER: This skill MUST be followed whenever creating or modifying ANY frontend file.
  This includes: React components (.tsx, .jsx), HTML files, CSS/SCSS/Tailwind files,
  page layouts, UI components, design tokens, animation code, styling utilities,
  Storybook stories, or any file that affects visual presentation. If you are writing
  or editing code that renders UI in a browser, this skill is mandatory.
---
